...
import {
  ecommerceWorkflowGroups,
  type EcommerceWorkflowGroup,
} from "@/lib/ecommerce";
...
export default function EcommerceWorkflows() {
  return (
    <section id="ecommerce-workflows" className="bg-canvas">
      <div className="mx-auto max-w-6xl px-5 py-16 md:py-24">
        <Reveal>
          ...
          <p className="mt-5 max-w-2xl text-lg text-body">
            Outbound voice that protects margin on COD and recovers revenue from
            carts and returns — logged on every call.
          </p>
        </Reveal>

        <div className="mt-12 grid gap-6 lg:grid-cols-2">
          {ecommerceWorkflowGroups.map((group) => (
            <WorkflowGroupCard
              key={group.id}
              group={group}
