...
export default function SoftAurora({
  ...
  useEffect(() => {
    ...
    function handleMouseMove(e: MouseEvent) {
      // Use cached rect — avoid getBoundingClientRect() every pointer move
      // (that reflowed after any layout invalidation from the canvas itself).
      targetMouse = [
        (e.clientX - canvasRect.left) / canvasRect.width,
        1.0 - (e.clientY - canvasRect.top) / canvasRect.height,
      ];
    }
